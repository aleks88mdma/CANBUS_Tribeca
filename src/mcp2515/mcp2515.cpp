...
MCP2515::ERROR MCP2515::setBitrate(const uint32_t canSpeed)
{
    return setBitrate(canSpeed, 16000000UL);
}

MCP2515::ERROR MCP2515::setBitrate(const uint32_t canSpeed, uint32_t canClock)
{
    ...
    switch (canClock)
    {
        ...
        switch (canSpeed)
        {
            ...
            case (31250):                                              //  31.25KBPS
            cfg1 = MCP_8MHz_31k25BPS_CFG1;
            cfg2 = MCP_8MHz_31k25BPS_CFG2;
            cfg3 = MCP_8MHz_31k25BPS_CFG3;
            break;

            case (33300):                                              //  33.33KBPS
